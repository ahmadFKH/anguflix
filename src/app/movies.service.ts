...
export class MoviesService {
  ...
  deleteMovie(id: number, movies: Array<Movie>) {
  ...
  reduceBudget(movie: Movie, user: User) {
    user.budget -= movie.price;
  }
  increaseBudget(movie: Movie, user: User) {
    user.budget += movie.price;
  }
}
